...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3" style="margin-left: -80px">
                                    <a href="#" class="tampilkanlaporan_whatssap_message_today btn btn-warning" id="btnTambahBeritaSatker">
                                    ...
                                    <table class="table table-bordered"
                                        ...
                                        @foreach($berita_satker as $d)
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    <div class="btn-group">
                                                        {{--edit disini--}}
                                                        <a href="#" class="tampilkanlaporan_whatssap btn btn-warning btn-sm"
    ...
    <div class="modal modal-blur fade" id="modal-tampilkandetail_whatssap" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Laporan Whatssap</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@push('myscript')
    <script>
        $(function () {
            ...
            $('.tampilkanlaporan_whatssap').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/datasatker/whatssapgenerate',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id_berita: id_berita,
